...
const base =
  'group/cta relative inline-flex items-center justify-center gap-2.5 overflow-hidden whitespace-nowrap rounded-full px-6 py-3.5 text-[13px] font-semibold tracking-[0.04em] transition-[transform,box-shadow,background-color,border-color,color] duration-300 ease-out active:translate-y-px'

const variants: Record<Variant, string> = {
  primary:
    'bg-accent text-white shadow-[0_1px_0_0_rgba(255,255,255,0.25)_inset,0_14px_28px_-14px_rgba(43,98,240,0.65)] hover:-translate-y-0.5 hover:shadow-[0_1px_0_0_rgba(255,255,255,0.25)_inset,0_20px_36px_-14px_rgba(43,98,240,0.8)]',
  inverse:
