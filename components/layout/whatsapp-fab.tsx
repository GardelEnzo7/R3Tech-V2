...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      aria-hidden={!shown}
      className={cn(
        'group/fab fixed right-5 bottom-5 z-30 grid size-14 place-items-center rounded-full bg-accent-solid text-white shadow-[0_18px_36px_-14px_rgba(43,98,240,0.85)] transition-all duration-500 ease-out hover:-translate-y-0.5 hover:shadow-[0_22px_44px_-14px_rgba(43,98,240,1)] md:right-8 md:bottom-8',
